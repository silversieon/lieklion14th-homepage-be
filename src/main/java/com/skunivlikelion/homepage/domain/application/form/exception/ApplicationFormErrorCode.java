...
public enum ApplicationFormErrorCode implements BaseErrorCode {
  ...
  CANNOT_DELETE_FORM_WITH_RECORDS(
      "APPFORM4092", "등록된 지원서가 있는 모집 공고는 삭제할 수 없습니다.", HttpStatus.CONFLICT),
  DATE_RANGE_OVERLAPPED(
      "APPFORM4093", "다른 모집 공고 기간(모집 시작~최종 발표)과 겹쳐 등록/수정할 수 없습니다.", HttpStatus.CONFLICT),
  ;
