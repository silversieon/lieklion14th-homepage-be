...
public enum ApplicationRecordErrorCode implements BaseErrorCode {
  ...
  FORM_NOT_OPENED("APPREC4004", "현재 모집 기간이 아닙니다.", HttpStatus.BAD_REQUEST),
  ANSWER_TOO_LONG("APPREC4005", "답변은 최대 500자까지 입력할 수 있습니다.", HttpStatus.BAD_REQUEST),

  NOT_FOUND_APPLICATION_FORM("APPREC4041", "모집 공고가 존재하지 않습니다.", HttpStatus.NOT_FOUND),
  NOT_FOUND_DRAFT("APPREC4042", "임시 저장된 지원서가 존재하지 않습니다.", HttpStatus.NOT_FOUND),
  NOT_FOUND_RECORD("APPREC4043", "지원서가 존재하지 않습니다.", HttpStatus.NOT_FOUND),

  ALREADY_SUBMITTED("APPREC4091", "이미 제출된 지원서입니다.", HttpStatus.CONFLICT),
  ALREADY_DRAFT_EXISTS("APPREC4092", "이미 임시저장된 지원서가 존재합니다.", HttpStatus.CONFLICT),
  ;
